...
$(document).ready(function(){
			$("#btnJoin").click(function(){
				...
				var pass_confirm = $("#password_confirm").val();
					...
					alert("회원가입 완료!");
					document.frm.action="regUser.do";
			});
		});
</script>
...
<div class="text-center" style="padding:50px 0">
	...
	<div class="login-form-1">
		<form id="registerform" class="text-left"  method="post">
			...
			<div class="main-login-form">
				...
				<button type="submit" class="login-button" id="btnJoin"><i class="fa fa-chevron-right"></i></button>
			</div>
